  ...
  return (
    <div className="flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400">
      ...
      <ul className="hidden md:flex items-start gap-5 font-medium">
        ...
        <NavLink to="/health-camps">
          <li className="py-1">HEALTH CAMPS</li>
          <hr className="border-none outline-none h-0.5 bg-[#5f6FFF] w-3/5 m-auto hidden" />
        </NavLink>
      </ul>
        ...
        {token && userData ? (
          <div className="flex items-center gap-2 cursor-pointer group relative">
            ...
            <div className="absolute pt-14 top-0  right-0 text-base font-medium text-gray-600 z-20 hidden group-hover:block">
              <div className="min-w-48 bg-stone-100 roundedn flex flex-col gap-4 p-4">
          ...
          <button
            ...
            className="bg-[#5f6FFF] text-white px-8 py-3 rounded-full font-light cursor-pointer hidden md:block"
          >
            Create Account
          </button>
        )}
